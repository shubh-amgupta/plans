...
export default class PricingForm extends React.Component {
    ...
    // if we receive new plan or modal status changes, update
    componentDidUpdate(prevProps) {
        const { selectedPlan } = this.props;
        if ((prevProps.selectedPlan && prevProps.selectedPlan.planId) !== (selectedPlan && selectedPlan.planId)) {
            this.setState({
                name: undefined,
                email: undefined,
                phone: undefined,
